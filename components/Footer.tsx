    ...
    <footer className="w-full bg-black border-t border-zinc-900 py-12 px-6 mt-auto">
      <div className="max-w-screen-2xl mx-auto flex flex-col items-center">
        ...
        <div className="mb-10">
          <Link href="/" className="group">
             <Image 
               ...
               width={160} 
               height={60} 
               className="w-40 h-auto object-contain transition-all duration-500 group-hover:scale-110"
               // ALTTAKİ STYLE LOGOYU TAM TURUNCU YAPAR VE PARLATIR
               style={{ 
                 filter: "brightness(0) saturate(100%) invert(42%) sepia(93%) saturate(1455%) hue-rotate(345deg) brightness(96%) contrast(101%) drop-shadow(0 0 8px rgba(255, 87, 34, 0.3))" 
               }}
               priority
             />
          </Link>
        ...
        <div className="flex flex-col items-center space-y-6">
          <a href="tel:+905384843361" className="text-[#FF5722] font-black italic tracking-widest text-[11px] hover:scale-105 transition-transform">+90 538 484 33 61</a>
          
          <div className="flex space-x-8 items-center">
            <a href="https://www.instagram.com/mcperformance.tr" target="_blank" className="text-zinc-500 hover:text-white transition-colors">
            ...
            <a href="https://www.youtube.com/@mcperformance" target="_blank" className="text-zinc-500 hover:text-white transition-colors">
